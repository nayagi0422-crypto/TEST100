"""Download Hanmi Semiconductor daily OHLCV data in LEAN custom-data format."""
...
def main() -> None:
    ...
    url = f"https://query1.finance.yahoo.com/v8/finance/chart/042700.KS?{query}"
    ...
    if written == 0:
        raise RuntimeError("No Hanmi Semiconductor price rows were downloaded")
